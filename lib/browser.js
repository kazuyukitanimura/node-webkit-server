...
Browser.prototype.highlightRender = function(width, height, text, callback) {
  if (callback) {
    this.command("HighlightRender", width, height, text, callback);
  } else {
    callback = text;
    this.command("HighlightRender", width, height, '', callback);
  }
};
